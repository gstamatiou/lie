...
\begin{exercise}[Invariant forms for irreducible representations are non-degenerate]
...
\begin{exercise}[Geometric characterisation of $\PSO(n, \mathbb C)$]
...
\begin{exercise}[The highest weight lies in the Weyl chamber]\label{ex:highest_weight_inside_weyl_chamber}
...
\begin{exercise}[Dual space as a wedge product]\label{ex:dual_space_as_wedge_product}
    \begin{enumerate}[label = (\alph*)]
